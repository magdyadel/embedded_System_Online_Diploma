...
//USART-Enable
#define NVIC_IRQ37_USART1_Enable				(NVIC_ISER1 |= 1<<(USART1_IRQ - 32)) //IRQ-32=5
...
//USART-Disable
#define NVIC_IRQ37_USART1_Disable				(NVIC_ICER1 |= 1<<(USART1_IRQ - 32)) //IRQ-32=5
...
//SPI-Enable
#define NVIC_IRQ35_SPI1_Enable					(NVIC_ISER1 |= 1<<(SPI1_IRQ - 32)) //IRQ-32=5
#define NVIC_IRQ36_SPI2_Enable					(NVIC_ISER1 |= 1<<(SPI2_IRQ - 32)) //IRQ-32
//SPI-Disable
#define NVIC_IRQ35_SPI1_Disable					(NVIC_ICER1 |= 1<<(SPI1_IRQ - 32)) //IRQ-32=5
#define NVIC_IRQ36_SPI2_Disable					(NVIC_ICER1 |= 1<<(SPI2_IRQ - 32)) //IRQ-32


//I2C-Enable
#define NVIC_IRQ31_I2C1_EV_Enable				(NVIC_ISER0 |= 1<<(I2C1_EV_IRQ)) //NVIC_ISER0 till 31
#define NVIC_IRQ32_I2C1_ER_Enable				(NVIC_ISER1 |= 1<<(I2C1_ER_IRQ - 32)) //IRQ-32=0
#define NVIC_IRQ33_I2C2_EV_Enable				(NVIC_ISER1 |= 1<<(I2C2_EV_IRQ - 32)) //IRQ-32
#define NVIC_IRQ34_I2C2_ER_Enable				(NVIC_ISER1 |= 1<<(I2C1_ER_IRQ - 32)) //IRQ-32
//I2C-Disable
#define NVIC_IRQ31_I2C1_EV_IRQ_Disable				(NVIC_ICER0 |= 1<<(I2C1_EV_IRQ )) //
#define NVIC_IRQ32_I2C1_ER_IRQ_Disable				(NVIC_ICER1 |= 1<<(I2C1_ER_IRQ - 32)) //IRQ-32=5
#define NVIC_IRQ33_I2C2_EV_IRQ_Disable				(NVIC_ICER1 |= 1<<(I2C2_EV_IRQ - 32)) //IRQ-32=5
#define NVIC_IRQ34_I2C2_ER_IRQ_Disable				(NVIC_ICER1 |= 1<<(I2C2_ER_IRQ - 32)) //IRQ-32=5
//=========================================================
